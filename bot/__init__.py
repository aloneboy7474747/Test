...
class Var:
    ...
    SIDE_CHANNEL = int(getenv("SIDE_CHANNEL") or 0)  # Channel where quality files are uploaded
    ...
    HELP_MSG = [
        ...
        (
            ...
            "<blockquote>• /addanime name - @main [- @side] - Map anime (optional side channel for quality files)\n"
            "• /delanime - Remove anime mapping\n"
            "• /delallanimes - Remove all anime mapping\n"
            "• /listanimes - List anime channels\n"
            "• /animeinfo - Get AniList info for any anime\n"
            "• /searchanime - Search AniList top 5 results\n"
            "• /setbanner - Set anime banner\n"
            "• /viewbanner - View anime banner\n"
            "• /delbanner - Remove anime banner\n"
            "• /delallbanners - Remove all anime banners\n"
